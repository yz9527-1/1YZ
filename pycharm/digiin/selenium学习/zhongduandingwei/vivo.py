...
driver.find_element_by_xpath("//*[@resource-id='com.app.digiin.project.sdkdemo:id/accountEditTxt']").send_keys("2020052806")
...
for i in range(1,10000):
    try:
        ...
        driver.find_element_by_xpath("//*[@resource-id='com.app.digiin.project.sdkdemo:id/accountEditTxt']").click()
        driver.find_element_by_xpath("//*[@resource-id='com.app.digiin.project.sdkdemo:id/accountEditTxt']").clear()
        driver.find_element_by_xpath("//*[@resource-id='com.app.digiin.project.sdkdemo:id/accountEditTxt']").send_keys(
            "2020052806")
        continue
