...
#:
#: * Key: Value as defined in the os-release file, translated to lower test,
...
#:   test, with blanks translated to underscores.
#:
#: * Value: Normalized value.
NORMALIZED_LSB_ID = {
...
#:   translated to lower test, with blanks translated to underscores.
#:
#: * Value: Normalized value.
...
def id():
    ...
    * it is translated to lower test,
